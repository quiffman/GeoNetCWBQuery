...
java -jar ../lib-ivy/external/GeoNetCWBQuery-2.0.0-RC1.jar -t ms -b "2007/05/12 07:30:00" -s "NZTSZ..HHN10" -d 1800 -o $tmpdir/test-data/gov/usgs/anss/query/filefactory/event/%N.ms
java -jar ../lib-ivy/external/GeoNetCWBQuery-2.0.0-RC1.jar -t sac -sacpz nm -b "2007/05/12 07:30:00" -s "NZTSZ..HHN10" -d 1800 -o $tmpdir/test-data/gov/usgs/anss/query/filefactory/event/%N.sac
